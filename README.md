...
<!-- 💻 대시보드 미리보기 스크린샷 -->
<p align="center">
  <img src="./images/dashboard.png" alt="대시보드 메인 화면 스크린샷" width="100%">
</p>
---
...
### 1. [ECharts 공통 컴포넌트 분리와 Series 타입 오류 (과도한 추상화의 위험성)](https://en-joy-coding.tistory.com/119)
...
### 2. [Vue 3에서 ECharts 사용 시 ref 대신 shallowRef를 사용해야 하는 이유](https://en-joy-coding.tistory.com/120)
...
### 3. [Pinia Store에서 useQuasar와 Dialog가 동작하지 않는 이유](https://en-joy-coding.tistory.com/122)
